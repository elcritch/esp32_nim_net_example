...
gcc   -o example_server  stdlib_io.nim.c.o stdlib_system.nim.c.o stdlib_posix.nim.c.o stdlib_times.nim.c.o stdlib_os.nim.c.o stdlib_nativesockets.nim.c.o @mexample_server.nim.c.o  -lm -pthread -lm   -ldl
