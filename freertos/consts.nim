...
type
  TickType_t* = uint32
#   INNER_C_UNION_consts_39* {.importcpp: "no_name", header: "consts.h", bycopy.} = object {.
#       union.}
...
#   StaticSemaphore_t* = StaticQueue_t
  ...
  shared_vector_desc_t* {.importcpp: "shared_vector_desc_t", header: "consts.h",
...
type
  vector_desc_t* {.importcpp: "vector_desc_t", header: "consts.h", bycopy.} = object ##  int flags: 16;                          //OR of VECDESC_FLAG_* defines
                                                                             ##  unsigned int cpu: 1;
  ...
  intr_handle_data_t* {.importcpp: "intr_handle_data_t", header: "consts.h", bycopy.} = object
